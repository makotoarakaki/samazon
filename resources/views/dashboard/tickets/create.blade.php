...
<div class="w-50">
    ...
    <form method="POST" name="form1" action="/dashboard/events/ticket" class="mb-5" enctype="multipart/form-data">
        {{ csrf_field() }}
        ...
        <div class="form-inline mt-4 mb-4 row">
            ...
            <ul class="radios">
                <li>
                    <input type="radio" name="tax_flg" id="ticket-tax_flg1" value="1">
                    <label for="ticket-tax_flg1">税込価格</label>
                </li>
                <li>
                    <input type="radio" name="tax_flg" id="ticket-tax_flg2" value="2" checked> 
